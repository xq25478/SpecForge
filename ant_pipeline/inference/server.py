...
def create_extra_llm_config(args, trtllm_version="v1.0.0rc3") -> Dict[str, Any]:
    VERSION_CONFIGS = {
        "0.20.0rc1": {
            ...
            "sampler": {"enable_key": "enable_trtllm_sampler"}
        },
        "0.20.0rc3": {
            "kv_cache": {
                "config_key": "kv_cache_config",
    ...
    # 处理 sampler 配置
    sampler_config = version_config["sampler"]
    if "type_key" in sampler_config:  # 1.2.0rc0 及以上版本
        # sampler_type: "TRTLLMSampler", "TorchSampler" 或 "auto"
        sampler_type = args.sampler_type
        config[sampler_config["type_key"]] = sampler_type
    elif "enable_key" in sampler_config:  # 旧版本
        # enable_trtllm_sampler: True/False
        config[sampler_config["enable_key"]] = not args.disable_trtllm_sampler
...
def parse_arguments() -> argparse.Namespace:
    ...
    # 添加 sampler_type 参数
    parser.add_argument("--sampler_type", type=str, default="auto",
                      choices=["TRTLLMSampler", "TorchSampler", "auto"],
                      help="Sampler type (default: auto)")
